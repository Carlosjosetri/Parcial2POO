...
public class FactoryMiliciaEspecial {
    public static Edificio getEdificio(String tipo) {
        switch (tipo) {
            case "DRAIOCHT":
                return new EdificioMiliciaEspecial.EdificioBuilder().nombre("Edificio de Milicia Especial ").Precio1(800).Precio2(200).Precio3(100)
            ...
            case "EPIGEIAN":
                return new EdificioMiliciaEspecial.EdificioBuilder().nombre("Edificio de Milicia Especial ").Precio1(1000).Precio2(300).Precio3(200)
