...
public class FactoryMilicia {
    public static Edificio getEdificio(String tipo) {
        switch (tipo) {
            case "DRAIOCHT":
                return new EdificioMilicia.EdificioBuilder().nombre("Edificio de Milicia DRAIOCHT").Precio1(200).Precio2(100).Precio3(100)
                        .vida(2000).Trabajo(1).Construccion(1).disponible("En construccion").disponiblilidad(false).build();
            case "HUMANO":
               return new EdificioMilicia.EdificioBuilder().nombre("Edificio de Milicia HUMANO").Precio1(300).Precio2(200).Precio3(50)
                        .vida(1800).Trabajo(1).Construccion(2).disponible("En construccion").disponiblilidad(false).build();
            case "EPIGEIAN":
                return new EdificioMilicia.EdificioBuilder().nombre("Edificio de Milicia EPIGEIAN").Precio1(400).Precio2(300).Precio3(100)
